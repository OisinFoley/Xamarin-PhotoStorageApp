...
namespace MainMobileDevProject
{
    public class CreateContactEventArgs : EventArgs
    {
        ...
        //might need to delete, here for testing
        public CreateContactEventArgs(string name, string number, byte[] imgdata)
        {
            Name = name;
            Number = number;
            ImgData = imgdata;
    ...
    public class CreateContactDialog : DialogFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var view = inflater.Inflate(Resource.Layout.dialog_sign_up1, container, false);
